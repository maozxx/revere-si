...
public class Reversi {
    ...
    public Reversi() // פעולת בונה ראשית
    {
        int mid;
        mid = rows / 2;
    ...
    public Reversi(Reversi obje) // פעולת בונה 2 מאפסת
    {
        int y;
        char c, x;
        gameCells = new Cell[8][8];
    ...
    public void findLegalMove(ArrayList <Integer> arr) // בדיקה לאן מהלך מותר לשחקן
    {
        int status;
        int change,max = 0; 
        change = 0;
